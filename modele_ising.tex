...
\end{prop}
\paragraph{preuve}
$$\frac{\langle \sigma_0 \sigma_y \rangle\langle\sigma_y \sigma_x\rangle}{\langle \sigma_0 \sigma_x\rangle} = \frac{Z(\{0,y\})Z(\{y,x\})}{Z(\{0,x\})Z(\emptyset)} = \frac{\sum_{\partial n_1=\{0,x\},\partial n_2= \emptyset} w(n_1)w(n_2)\mathbf{1}(x\rightarrow y)}{\sum_{\partial n_1 = \{0,x\},\partial n_2 = \emptyset}w(n_1)w(n_2)} = P^{\{0,x\}}\otimes P^\emptyset(x\rightarrow y)
$$
On somme les $y\in S$ et on a 
$$\sum_{y\in S}\frac{\langle \sigma_0 \sigma_y \rangle\langle\sigma_y \sigma_x\rangle}{\langle \sigma_0 \sigma_x\rangle} = \sum_{y\in S}P^{\{0,x\}}\otimes P^\emptyset(x\rightarrow y) \geqslant 1.
$$
\end{document}
